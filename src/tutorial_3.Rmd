...
For plotting interactively we will use the map_leaflet() function as part of the mapr package (I'm not showing the plot here, because it messes up the html file)
